<template>
  <div>
    <div class="subsection">
      <h1>Koil Finance OU Privacy&nbsp;Policy</h1>
      <p><em>Last Updated: November 16, 2021</em></p>
      <p>
        <em class="font-medium">
          This Privacy Policy explains how Koil Finance OU and its subsidiaries
          and affiliates (“Koil Finance,” “we,” “our,” or “us”) collects, uses,
          and discloses information about you. This Privacy Policy applies when
          you use our website, Koil Protocol user-interface or application and
    ...
    <div class="subsection">
      ...
      <p>
        The Koil Finance UI is not directed to children under the age of 16. If
        ...
        <a class="link" href="mailto:privacypolicy@koil.finance"
          >privacypolicy@koil.finance</a
      ...
      <p>
        ...
        accessible to Koil Finance and its vendor(s).
      </p>
    </div>
    <div class="subsection">
      ...
      <ul>
        <li>Ensure proper functioning of Koil Finance and the UI;</li>
        <li>
        ...
        <li>
          ...
          rights and property of Koil Finance and others;
        </li>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        the normal course of Koil Finance business. However, when Koil Finance
      ...
      <ul>
        ...
        <li>
          ...
          the rights, property, and safety of Koil Finance, the Koil ecosystem,
        ...
        <li>
          Personal information may be shared between and among Koil Finance and
    ...
    <div class="subsection">
      ...
      <p>
        ...
        customized campaigns on the UI or third-party UIs. Koil Finance may
    ...
    <div class="subsection">
      ...
      <p>
        Koil Finance is headquartered in Estonia. Therefore, we and our service
    ...
    <div class="subsection">
      ...
      <h3>Cookies</h3>
      <p>
        Koil Finance does not typically use any cookies. It reserves the ability
        to use them to affect the availability and functionality of the UI. For
    ...
    <div class="subsection">
      ...
      <p>
        Koil Finance does not “sell” personal information to advertise our
      ...
      <p>
        ...
        requests by emailing us at privacypolicy@koil.finance. If we receive
      ...
      <p>
        Koil Finance does not share such information with third parties for
    ...
    <div class="subsection">
      ...
      <p>
        Koil Finance does not typically process user personal data. If Koil
      ...
      <p>
        ...
        certain processing. Koil Finance does not typically hold such personal
        data.
      </p>
    </div>
    <div>
